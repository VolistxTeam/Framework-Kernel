...
class SubscriptionCancellationPreProcessor extends RequestPreProcessorBase
{
    ...
    public function Process(): bool|array
    {
        ...
        if ($subscription->status === SubscriptionStatus::ACTIVE && !empty($subscription->cancels_at) && Carbon::now()->gte($subscription->cancels_at)) {
